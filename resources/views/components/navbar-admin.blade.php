<div class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <aside
        ...
        <div class="h-full px-3 py-5 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2">
                <li>
                    <a href="/admin" :active="request() - is('home-admin')"
                ...
                <li>
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <x-nav-link-admin href="/students-admin" :active="request()->is('students-admin')">Student</x-nav-link-admin>
                        </li>
                        <li>
                            <x-nav-link-admin href="/grade-admin" :active="request()->is('grade-admin')">Grade</x-nav-link-admin>
                        </li>
                        <li>
                            <x-nav-link-admin href="/department-admin" :active="request()->is('department-admin')">Department</x-nav-link-admin>
                        </li>
                    </ul>
                </li>
                <li>
